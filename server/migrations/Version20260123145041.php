 ...
 */
final class Version20260123145041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification (id UUID NOT NULL, type VARCHAR(64) NOT NULL, text TEXT NOT NULL, target JSONB NOT NULL, payload JSONB NOT NULL, group_key VARCHAR(120) DEFAULT NULL, group_count INT DEFAULT 1 NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, last_event_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, recipient_id UUID NOT NULL, actor_id UUID DEFAULT NULL, PRIMARY KEY (id))');
